...
async function testReadFile() {
  const testPath = '/Users/damienschneider/Documents/GitHub/electron-shadcn/CLAUDE.md';
...
async function testReadDirectory() {
  ...
  try {
    ...
    console.log('Entries:', entries.map(e => ({ name: e.name, isFile: e.isFile(), isDir: e.isDirectory() })));
