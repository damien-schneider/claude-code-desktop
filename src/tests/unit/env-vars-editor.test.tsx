...
describe('EnvVarsEditor', () => {
  it('should render all environment variables', () => {
    ...
    expect(screen.getByText('Authentication token for Anthropic API')).toBeInTheDocument();
    expect(screen.getByText('Request timeout in milliseconds')).toBeInTheDocument();
